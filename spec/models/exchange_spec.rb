...
describe Exchange do
  ...
  it "only includes specific data in the json" do
    ...
    exchanges = [exchange]
    json_expected = /{\"_id\":\"\w+\",\"parent_exchange_id\":null,\"parent_entry_id\":null,\"parent_comment_id\":null,\"ordered_user_ids\":\[\],\"ordered_usernames\":\[\],\"entry_data\":\[{\"_id\":\"\w+\",\"content\":null,\"user_id\":\"\w+\",\"exchange_id\":\"\w+\",\"username\":\"\w+\",\"comments\":\[{\"_id\":\"\w+\",\"content\":null,\"exchange_id\":\"\w+\",\"entry_id\":\"\w+\",\"entry_user_id\":\"\w+\",\"child_exchange_data\":null,\"user_username\":\"\w+\"}\]}\]}/
